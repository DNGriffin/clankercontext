...
/**
 * v1.1.6 frozen templates - DO NOT MODIFY
 * These represent the template format at v1.1.6 for backward compatibility testing.
 * They use the {{elements_markdown}} token which should continue to work.
 */
export const V1_1_6_FIX_TEMPLATE = `# Bug Fix
...
export const V1_1_6_ENHANCEMENT_TEMPLATE = `# Enhancement
