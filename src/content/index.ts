...
function createSelectedHighlight(element: Element, index: number): HTMLDivElement {
  ...
  highlight.style.cssText = `
    ...
    border: 2px solid oklch(70% 0.18 145) !important;
    background: oklch(70% 0.18 145 / 0.1) !important;
    box-shadow: 0 0 12px oklch(70% 0.18 145 / 0.4) !important;
  ...
  badge.style.cssText = `
    ...
    background: oklch(70% 0.18 145) !important;
    color: oklch(8% 0.01 240) !important;
    ...
    box-shadow: 0 0 8px oklch(70% 0.18 145 / 0.5) !important;
  `;
...
function showCopiedToast(): void {
  ...
  toast.style.cssText = `
    ...
    color: oklch(92% 0.01 240) !important;
    border: 1px solid oklch(70% 0.18 145 / 0.5) !important;
    border-radius: 2px !important;
    font-family: 'JetBrains Mono', 'SF Mono', monospace !important;
    font-size: 12px !important;
    text-transform: uppercase !important;
    letter-spacing: 0.1em !important;
    box-shadow: 0 0 16px oklch(70% 0.18 145 / 0.3), 0 4px 12px rgba(0, 0, 0, 0.4) !important;
    display: flex !important;
    align-items: center !important;
    gap: 10px !important;
    opacity: 1 !important;
  ...
  checkmark.style.cssText = `
    color: oklch(70% 0.18 145) !important;
...
function startElementPicker(): void {
  ...
  highlightElement.style.cssText = `
    ...
    pointer-events: none !important;
    z-index: 2147483647 !important;
    border: 2px solid oklch(72% 0.15 195) !important;
    background: oklch(72% 0.15 195 / 0.1) !important;
    box-shadow: 0 0 12px oklch(72% 0.15 195 / 0.4) !important;
  ...
  tooltipElement.style.cssText = `
    ...
    background: oklch(12% 0.015 240) !important;
    color: oklch(92% 0.01 240) !important;
    border: 1px solid oklch(72% 0.15 195 / 0.5) !important;
    border-radius: 2px !important;
    font-family: 'JetBrains Mono', 'SF Mono', monospace !important;
    font-size: 12px !important;
    box-shadow: 0 0 16px oklch(72% 0.15 195 / 0.3), 0 4px 12px rgba(0, 0, 0, 0.4) !important;
